...
class DefaultAuthorizationRedirectUrlProviderSpec extends Specification {
    ...
    void "AuthorizationRedirectUrlProvider build a url"() {
        ...
        and:
        authorizationRedirectUrlProvider.resolveAuthorizationRedirectUrl() == "https://micronautguides.auth.eu-west-1.amazoncognito.com/oauth2/authorize?scope=openid&response_type=codeclient_id=XXXX&response_mode=query"
