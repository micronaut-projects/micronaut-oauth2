 ...
 * @since 1.1.0
 */
@Requires(beans = {IdTokenAccessTokenResponseValidator.class, NotValidIdTokenAccessTokenResponseHandler.class, SuccessfulIdTokenAccessTokenResponseHandler.class})
@Singleton
public class DefaultIdTokenAccessTokenResponseHandler implements IdTokenAccessTokenResponseHandler {
    ...
    public HttpResponse handle(IdTokenAccessTokenResponse idTokenAccessTokenResponse) {
        if (idTokenAccessTokenResponseValidator.validate(idTokenAccessTokenResponse)) {
            return successfulIdTokenAccessTokenResponseHandler.handle(idTokenAccessTokenResponse);
        }
